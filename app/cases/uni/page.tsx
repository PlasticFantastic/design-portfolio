...
const canvasImages = [
  'u-1.webp', 'u-2.webp', 'u-3.webp', 'u-3-1.webp', 'u-4.webp', 
  'u-5.webp', 'u-6.webp', 'u-7.webp', 'u-8.webp', 'u-9.webp', 
  'u-10.webp', 'u-11.webp', 'u-12.webp', 'u-13.webp', 'u-14.webp', 
  'u-15.webp', 'u-16.webp', 'u-17.webp', 'u-18.webp', 'u-19.webp', 'u-20.webp'
];

export default function UniCasePage() {
  ...
  const otherCases = ALL_CASES.filter((item) => {
    ...
    return slug !== 'uni' && slug !== 'uni-doc' && !slug.includes('uni');
  }).slice(0, 3);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-lg sm:text-2xl lg:text-3xl font-light text-gray-600 leading-relaxed font-sans max-w-xl">
              Корпоративный сайт для инвестиционной компании
            </p>
          </motion.div>
