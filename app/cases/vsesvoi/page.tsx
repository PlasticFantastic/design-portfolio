// src/app/cases/vsesvoi/page.tsx
'use client';
...
const canvasImages = [
  'svo1.webp', 'svo2.webp', 'svo3.webp', 'svo4.webp', 'svo5.webp', 
  'svo6.webp', 'svo7.webp', 'svo8.webp', 'svo9.webp', 'svo10.webp'
];

export default function VsesvoiCasePage() {
  ...
  // Исключаем текущий кейс (проверяем все варианты slug Vse Svoi)
  const otherCases = ALL_CASES.filter((item) => {
    if (!item || !item.slug) return false;
    const slug = item.slug.toLowerCase();
    return slug !== 'vsesvoi' && slug !== 'vse-svoi' && !slug.includes('vsesvoi');
  }).slice(0, 3);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-lg sm:text-2xl lg:text-3xl font-light text-gray-600 leading-relaxed font-sans max-w-xl">
              Сервис поиска услуг во Франции
            </p>
          </motion.div>
          ...
          >
            <div className="w-full rounded-[20px] sm:rounded-[28px] overflow-hidden border border-gray-200/80 shadow-2xl shadow-black/10 bg-white">
              <Image 
                src="/cases/vsesvoi/cover-a.webp" 
                alt="Cover" 
                width={1200} 
                height={800} 
