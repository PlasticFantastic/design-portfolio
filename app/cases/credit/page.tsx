...
const canvasImages = [
  'kg1.webp', 'kg2.webp', 'kg3.webp', 'kg4.webp', 'kg5.webp', 
  'kg6.webp', 'kg7.webp', 'kg8.webp', 'kg9.webp', 'kg10.webp', 'kg11.webp'
];
...
export default function CreditCasePage() {
  ...
  // 1. Исключаем текущий кейс (проверяем все варианты slug Credit)
  const otherCases = ALL_CASES.filter((item) => {
    if (!item || !item.slug) return false;
    const slug = item.slug.toLowerCase();
    return slug !== 'credit' && slug !== 'credit-doc' && !slug.includes('credit');
  }).slice(0, 3);
