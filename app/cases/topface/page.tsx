// src/app/cases/topface/page.tsx
'use client';
...
const canvasImages = [
  'top1.webp', 'top2.webp', 'top3.webp', 'top4.webp', 'top5.webp', 
  'top6.webp', 'top7.webp', 'top8.webp', 'top9.webp', 'top10.webp', 
  'top11.webp'
];

export default function TopfaceCasePage() {
  ...
  // Исключаем текущий кейс (Topface) из списка рекомендаций
  const otherCases = ALL_CASES.filter((item) => {
    if (!item || !item.slug) return false;
    const slug = item.slug.toLowerCase();
    return slug !== 'topface' && !slug.includes('topface');
  }).slice(0, 3);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            <div className="w-full rounded-[20px] sm:rounded-[28px] overflow-hidden border border-gray-200/80 shadow-2xl shadow-black/10 bg-white">
              <Image 
                src="/cases/topface/cover-a.webp" 
                alt="Cover" 
                width={1200} 
                height={800} 
