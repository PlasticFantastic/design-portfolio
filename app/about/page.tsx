...
const education = [
  {
    ...
    university:
      'Таврическая академия КФУ им. В.И. Вернадского, г. Симферополь',
  },
  {
...
// ВАЖНО:
// Здесь намеренно нет ease.
// Это исключает конфликт Variants с типами Easing
// в разных версиях Framer Motion.
...
function TypewriterHeading() {
  ...
  return (
    <h1
      className={`${oswald.className} text-4xl sm:text-6xl lg:text-7xl font-bold uppercase tracking-tight text-[#111827] leading-[1.08] min-h-[2.2em] sm:min-h-[2.1em]`}
    >
      Проектирую{' '}
  ...
  return (
    ...
    >
      <div className="relative w-full h-full rounded-2xl overflow-hidden bg-[#111827]">
        ...
        {/* Второе фото с круговым раскрытием */}
        <motion.div
    ...
    <main className="relative w-full bg-[#111827] text-[#111827] overflow-x-hidden font-sans select-none antialiased">
      ...
      >
        ...
        <section className="relative z-10 w-full px-6 md:px-12 lg:px-16 py-8 lg:py-12 space-y-16 lg:space-y-24">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 border-b border-gray-200/80 pb-4">
              <div className="flex flex-wrap items-baseline gap-2 sm:gap-3">
                ...
                <h2
                  className={`${oswald.className} text-2xl sm:text-4xl font-bold uppercase tracking-tight text-[#111827]`}
                >
                  Опыт работы
                </h2>
          ...
          <div className="space-y-8">
            ...
            {/* Анимированная кнопка перехода к проектам */}
            <motion.div
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
      ...
      >
          ...
          <div className="relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            ...
            >
              ...
              <div className="space-y-4 z-10">
                ...
                <h3
                  className={`${oswald.className} text-3xl sm:text-4xl font-bold text-white uppercase tracking-tight`}
                >
                  Резюме PDF
                </h3>
        ...
        <footer className="relative w-full px-6 md:px-12 lg:px-16 py-5 border-t border-gray-800 bg-[#111827] text-[11px] font-mono text-gray-400 flex flex-col sm:flex-row justify-between items-center gap-2">
          <div>
            © 2026 NIKOLAY VISHNEV — ALL RIGHTS RESERVED
          </div>
